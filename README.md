...
**A golem requestor installation is needed to run this app. Please visit https://www.golem.netowork for details**
...
cd entropythief
git checkout alpha-v7.3 # note, the (multiple) named pipe model is being revised as too many causes problems
