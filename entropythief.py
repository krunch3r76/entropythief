...
try:
    ...
    print("Uh oh, did you forget to install the requirements? I could not find a required module: yapapi! Please see the readme for direction.")
    sys.exit(1)
...
print_env_info(args)
try:
    input("to change any of the settings, ctrl-c and pass the arguments desired on the command line.\n"
